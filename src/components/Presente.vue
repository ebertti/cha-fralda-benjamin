<template>
  <v-card elevation="0">
    <v-img class="mb-3 rounded-0 " cover height="240px" position="left center" :src="presente.icone"></v-img>
    <span class="d-block text-body-1 secondary--text font-weight-bold mb-0">{{ presente.nome }}</span>
